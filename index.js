...
*  |_|\_\___|\__|_|  |_/_/\_\                  
 *              
 *  Ketrix Panel 0.3.0 (Oz)
 *  (c) 2025 ZenpaiZombie and contributors
 * 
*/

/**
 * @fileoverview Main server file for Ketrix Panel. Sets up the express application,
...
app.listen(config.port, () => log.info(`Ketrix is listening on port ${config.port}`));

app.get('*', async function(req, res){
  res.render('errors/404', {
    req,
    name: await db.get('name') || 'Ketrix'
  })
});
